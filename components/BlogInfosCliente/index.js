...
class BlogInfosCliente extends Component {
  ...
  render(){
    ...
    {/* <Top>Cartb Blog - Informações e tutoriais</Top> */}    
        <Container> 
            ...
            <TopBanner>
              <Column>
                <Title>Blog {this.props.infos.nomefantasia}</Title>
                <SubTitle>Conteúdo grátis, matérias e novidades sobre contabilidade e empreendedorismo</SubTitle>
              </Column>
              <Column>
            ...
            <SubContainer>
              <Posts>
                {this.props.materias.map((i, index) => (
                  <Link href={'/'+this.props.infos.slug+'/blog/'+i.slug} key={index}>
                    <Post >
                      <PostPic src={i.img}/>
...
export default BlogInfosCliente;